...
namespace Sulu\Bundle\SyliusConsumerBundle\Model\RoutableResource\Exception;
...
class RoutableResourceNotFoundException extends ModelNotFoundException
{
    public function __construct(string $resourceKey, string $resourceId, $code = 0, \Throwable $previous = null)
    {
        parent::__construct(RoutableResource::class, sprintf('%s#%s', $resourceKey, $resourceId), $code, $previous);
    }
}
