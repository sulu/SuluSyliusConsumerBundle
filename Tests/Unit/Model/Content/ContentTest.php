...
class ContentTest extends TestCase
{
    ...
    {
        $content = new Content(ProductInterface::RESOURCE_KEY, 'product-1');
    ...
    {
        $content = new Content(ProductInterface::RESOURCE_KEY, 'product-1', 'default');
    ...
    {
        $content = new Content(ProductInterface::RESOURCE_KEY, 'product-1', 'default', ['title' => 'Sulu is awesome']);
    ...
    {
        $content = new Content(ProductInterface::RESOURCE_KEY, 'product-1', 'default', ['title' => 'Sulu is great']);
