...
class ListProductsQueryTest extends TestCase
{
    ...
    {
        $query = new ListProductsQuery(ProductInformation::class, ProductInterface::RESOURCE_KEY, 'en', 'app.products', ['page' => 1]);

        $this->assertEquals(ProductInformation::class, $query->getEntityClass());
    }
